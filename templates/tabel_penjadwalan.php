        ...
        <table class="table rounded">
                                            ...
                                            <?php $i=1;foreach ($hasil as $ambil) {?>
                                                <tr>
                                                    ...
                                                    <!-- Opsi -->
                                                    <td>
                                                        <a class="modalku" href="" id="modalku" data-toggle="modal" data-target="#ModalUbah" data-id="<?=$ambil['id_jadwal']?>">Edit</a> |
                                                        <!-- <a href='UI_Form_edit_jadwal.php?id_jadwal=<?=$ambil['id_jadwal']?>'>Edit</a> | -->
                                                        <a href='UI_Penjadwalan_detail_admin.php?nim=<?=$ambil['nim']?>'>Detail</a></td>
                                                </tr>
                                            <?php $i++;}?>
                                            </tbody>
                                        </table>
