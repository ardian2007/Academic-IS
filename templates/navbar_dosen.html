    ...
    <div class="container">
      ...
      <div class="col-6 text-center">
        <div class="navbar-nav ml-auto">
          ...
          <a class="nav-item nav-link ml-auto link2 mt-2" href="#">Nama Dosen<span class="sr-only ">(current)</span></a>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu navbox" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item  drop-link" href="#">List Mahasiswa Bimbingan</a>
                  <a class="dropdown-item  drop-link" href="#">Status Seminar Proposal</a>
                </div>
              </li>
              <!-- Skripsi -->
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu navbox" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item  drop-link" href="#">Status Pendadaran</a>
                </div>
              </li>
              <!-- Jadwal -->
              <li class="nav-item active">
