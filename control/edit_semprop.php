            ...
            if ($nilai_waktuDS==true) {
                if ($nilai_ruangDS==true) {
                    if ($nilai_ruangwaktudlmsehari==true) {
                        $akses->UpdateTabelPengujiByIdJadwal($idjadwal,$idjadwal_baru,$penguji1);
                        $akses->UpdateTabelPenjadwalanByIdJadwal($idjadwal,$idjadwal_baru,"SEMPROP",$nim,$tanggal,$waktu,$ruang);                        
                        ?>
                        <form id="my_form" action="../UI_Penjadwalan_detail_admin.php" method="GET">
                        ...
                        <?php
                    }else {include 'redirect/redirect_failed.php';echo "Ruang & waktu Penuh";}
                }else {include 'redirect/redirect_failed.php';echo "Ruang Penuh";}
            }else {include 'redirect/redirect_failed.php';echo "Waktu Penuh";}
    }else {include 'redirect/redirect_failed.php';echo "Penguji Penuh";}
